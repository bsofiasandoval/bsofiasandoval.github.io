...
$contador = $_GET['cont'];
$pot = $_GET['pot']; // Make sure you have a 'temp' GET parameter being sent from the NodeMCU
$color = $_GET['color'];
...
$consulta = "INSERT INTO potenciometro (contador, pot, color) VALUES (?, ?, ?)";
...
if ($stmt) {
    ...
    mysqli_stmt_bind_param($stmt, "ids", $contador, $pot, $color);
