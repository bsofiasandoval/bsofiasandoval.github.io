...
$contador = $_GET['cont'];
$temperatura = $_GET['temp']; // Make sure you have a 'temp' GET parameter being sent from the NodeMCU
$status = $_GET['status'];
...
$consulta = "INSERT INTO temperaturas (contador, temperatura, status) VALUES (?, ?, ?)";
...
if ($stmt) {
    ...
    mysqli_stmt_bind_param($stmt, "ids", $contador, $temperatura, $status);
